...
export async function handler(chatUpdate) {
    ...
    if (processedMessages.has(messageId)) {
        console.log(chalk.red(`[DUPLICADO] Mensaje con ID ${messageId} ya procesado. Ignorando.`));
        return;
    }
    ...
    if (currentTimestamp - messageTimestamp > 60) {
        console.log(chalk.yellow(`[FILTRO] Mensaje antiguo ignorado del chat ${m.chat}`));
        return;
    }
    ...
    try {
        ...
        try {
            ...
            if (chat) {
                ...
                global.db.data.chats[m.chat] = {
                    sAutoresponder: '', welcome: true, isBanned: false, autolevelup: false, autoresponder: false, delete: false, autoAceptar: false, autoRechazar: false, detect: true, antiBot: false, antiBot2: false, modoadmin: false, antiLink: true, antifake: false, antiArabe: false, reaction: false, nsfw: false, expired: 0, welcomeText: null, byeText: null, botPrimario: null,
                }
